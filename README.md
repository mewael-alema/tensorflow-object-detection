...
> **Note:** This project was built by following the tutorial by [Nicholas Renotte](https://github.com/nicknochnack). Full credit goes to him for the original course and materials. Original repository: [nicknochnack/TFODCourse](https://github.com/nicknochnack/TFODCourse) | YouTube: [Nicholas Renotte](https://www.youtube.com/c/nicholasrenotte)

<p>This set of Notebooks provides a complete set of code to be able to train and leverage your own custom object detection model using the Tensorflow Object Detection API. This accompanies the Tensorflow Object Detection course on Nicholas Renotte's <a href="https://www.youtube.com/c/nicholasrenotte">YouTube channel</a>. 
